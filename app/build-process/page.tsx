        ...
        <section className="bg-white py-20 lg:py-28">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              viewport={viewportOnce}
              custom={0}
              className="bg-gradient-to-br from-[#0d1b2a] to-[#1a2942] rounded-sm p-8 lg:p-12 shadow-2xl border border-[#C9A96E]/20"
            >
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                {/* Left: Value Prop */}
                <div>
                  <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#C9A96E]/20 rounded-full mb-6">
                    <svg
                    ...
                    <span className="text-[#C9A96E] text-xs font-semibold uppercase tracking-wider font-[family-name:var(--font-inter)]">
                      Free Download
                    </span>
                  </div>
                  <h3 className="font-[family-name:var(--font-playfair)] text-3xl lg:text-4xl font-bold text-white leading-tight mb-4">
                    Get Your Complete Build Timeline & Checklist
                  </h3>
                  <p className="text-white/70 text-base lg:text-lg leading-relaxed mb-6 font-[family-name:var(--font-inter)]">
                    Download our comprehensive PDF guide with detailed timelines, cost breakdowns, contractor checklists, and permit requirements for your metal building project.
                  </p>
                  <ul className="space-y-3">
                    {[
                      "Week-by-week timeline from permits to completion",
                      "Cost breakdown worksheet",
                      "Contractor evaluation checklist",
                      "Permit requirement guide by county",
                    ].map((item) => (
                ...
                <div>
                  <form
                    className="bg-white rounded-sm p-6 lg:p-8 shadow-xl"
                    data-vercel-form="build-process-guide"
                    onSubmit={async (e) => {
                      e.preventDefault();
                  ...
                  >
                    <input type="hidden" name="form-name" value="build-process-guide" />

                    <h4 className="text-lg font-bold text-[#0d1b2a] mb-4 font-[family-name:var(--font-inter)]">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <label
                          htmlFor="guide-building-type"
                          className="block text-xs font-semibold tracking-widest uppercase text-[#0d1b2a]/70 mb-2 font-[family-name:var(--font-inter)]"
                        >
                          Building Type
                        </label>
                        <select
                          id="guide-building-type"
                          name="buildingType"
                        ...
                        >
                          ...
                          <option value="RV Cover">RV Cover / Carport</option>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full h-12 px-4 rounded-sm border border-[#0d1b2a]/15 bg-white text-[#0d1b2a] font-medium font-[family-name:var(--font-inter)] focus:outline-none focus:border-[#C9A96E] focus:ring-2 focus:ring-[#C9A96E]/20 transition-colors"
                        >
                          <option value="">When are you building? (optional)</option>
                      ...
                      <p className="text-xs text-[#0d1b2a]/60 text-center font-[family-name:var(--font-inter)]">
